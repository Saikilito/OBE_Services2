...
import Styles from './medallas.module.css';

class MedalT extends Component {
  ...
  render() {
    return (
      ...
      <div className="bg-dark p-5 text-white text-center">
        <h2 className="display-3">Buscar Graduandos</h2>
      </div>
        ...
        students.map((e, i) => {
          ...
          let block = <div className="card shadow-lg mt-3">
                        ...
                        <form onSubmit={this.prevenForm} className="text-capitalize">
                          ...
                          <p className="card-text">{`Medalla Estatus: ${e.medal.status}`}</p>
